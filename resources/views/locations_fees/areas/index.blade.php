...
<br><br>
<table class="table table-bordered table-striped" id="lf_areas_table" style="width:100%">
    <thead>
        <tr>
            <th>@lang('locations_fees.governorate')</th>
            <th>@lang('locations_fees.city')</th>
            <th>@lang('locations_fees.area')</th>
            <th>@lang('locations_fees.area_delivery_cost')</th>
