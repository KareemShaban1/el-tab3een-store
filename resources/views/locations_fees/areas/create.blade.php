<div class="modal-dialog" role="document">
    <div class="modal-content">
        {!! Form::open(['url' => action([\App\Http\Controllers\LocationsFees\AreaController::class, 'store']), 'method' => 'post', 'id' => 'lf_area_form']) !!}
            ...
            <div class="form-group">
                ...
                <select name="city_id" class="form-control select2" required style="width:100%">
                    ...
                    @foreach($cities as $city)
                        <option value="{{ $city->id }}">{{ optional($city->governorate)->name }} — {{ $city->name }}</option>
                    @endforeach
                </select>
            </div>
            <div class="form-group">
