<div class="modal-dialog" role="document">
    {!! Form::open(['url' => action([\App\Http\Controllers\EcommerceSellController::class, 'updateEcommerceStatus'], [$transaction->id]), 'method' => 'post', 'id' => 'edit_ecommerce_status_form' ]) !!}
    <div class="modal-content">
        ...
        <div class="modal-body">
            <div class="row">
                ...
                @php
                    $is_payment_paid = !empty($transaction->payment_status) && $transaction->payment_status === 'paid';
                @endphp
                <div class="col-md-6">
                    <div class="form-group">
                        {!! Form::label('payment_status', __('sale.payment_status') . ':') !!}
                        {!! Form::select('payment_status', $payment_statuses, !empty($transaction->payment_status) ? $transaction->payment_status : null, ['class' => 'form-control select2', 'style' => 'width:100%', 'placeholder' => __('messages.please_select'), 'disabled' => $is_payment_paid]) !!}
                    </div>
                </div>
                <div class="col-md-6">
				<div class="form-group">
