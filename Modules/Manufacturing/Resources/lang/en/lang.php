...
return [
    ...
    'final_qty_formula_container' => 'Formula: output − (waste ÷ bulk per container)',
    'final_qty_formula_carton' => 'Formula: output − ((waste ÷ bulk per container) ÷ units per carton)',
    'bulk_after_waste_formula' => 'Formula: available stock − bulk consumed − waste (waste only if Finalize)',
    'final_qty_formula_live' => 'Formula: output (:output) − (waste (:waste) ÷ bulk/container (:bulk_per):carton_part) = :result',
    'bulk_after_waste_formula_live' => 'Formula: available (:available) − consumed (:consumed) − waste (:waste) = :result',
    'final_qty_carton_part_live' => ' ÷ units/carton (:units)',
    ...
    'uses_carton' => 'Pack into cartons',
    'uses_carton_help' => 'Uncheck to fill bottles/bags only (no outer carton). Output stock = containers count.',
    'packaging_mode' => 'Packaging mode',
    'pack_into_cartons' => 'Pack into cartons',
    'containers_only' => 'Containers / bottles only',
    'output_quantity' => 'Output quantity',
    'current_output_stock' => 'Current output stock',
    'units_per_carton_required' => 'Units per carton is required when packing into cartons.',
