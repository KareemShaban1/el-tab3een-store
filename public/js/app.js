$(document).ready(function() {
    ...
    // contacts table — only init on the contacts list page; app.js runs on every page
    if ($('#contact_table').length && $('#contact_type').length) {
        var contact_table_type = String($('#contact_type').val() || '').trim();
        var columns;
