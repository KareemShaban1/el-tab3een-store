...
return [
    ...
    'new_order' => 'New Order',
    'store_order_notification_tab3een' => 'New Tab3een store order :invoice_no from :customer',
    'store_order_notification_servo' => 'New Servo store order :servo_reference from :customer',
    'store_order_notification_mixed' => 'New mixed store order (Tab3een :invoice_no + Servo :servo_reference) from :customer',
    ...
    'product_tags_help' => 'Separate tags with commas. Search matches the product name or any tag.',
    ...
    'active_in_app' => 'Active in app / storefront',
    'tooltip_active_in_app' => 'If checked, this item can appear in the customer storefront and app catalog. Uncheck to hide it from those channels only.',
    'featured' => 'Featured',
    'tooltip_featured' => 'Featured items can be sorted first on the storefront and in listings that support featured ordering.',
    ...
    'stock_corrected_from_product_history' => 'Stock quantity corrected from product stock history',
    'manual_stock_correction_hint' => 'Updates stored quantity at this location. Logged in activity with your user.',
    'low_stock_by_location_button' => 'Low stock by location (< 1)',
    'low_stock_by_location_title' => 'Quantities below 1 by variation & location',
    'low_stock_by_location_help' => 'Each row is stored stock for one variation at one location. Edit quantities and save.',
    'low_stock_by_location_none' => 'No variation locations with quantity below 1.',
    ...
    'price_import_instruction_5' => 'You can update Product Description and Warranties columns for each product.',
    'servo_orders' => 'Servo orders',
    'servo_client_name' => 'Servo client name',
    'servo_reference' => 'Servo reference',
    'servo_order_details' => 'Servo order details',
    'local_order' => 'Local order',
    'request_payload' => 'Request payload',
    'response_payload' => 'Response payload',
    'technical_details' => 'Technical details',
    'order_items_tab3een' => 'Tab3een store items',
    'order_items_servo' => 'Servo partner items',
    'mixed_order' => 'Mixed order',
    'hero_banners' => 'Hero banners',
    'add_hero_banner' => 'Add hero banner',
    'edit_hero_banner' => 'Edit hero banner',
    'storefront_whatsapp' => 'WhatsApp button',
    'storefront_whatsapp_enabled' => 'Show floating WhatsApp button',
    'storefront_whatsapp_enabled_help' => 'When enabled, a floating WhatsApp button appears on the storefront home page.',
    'storefront_whatsapp_number' => 'WhatsApp number',
    'storefront_whatsapp_number_help' => 'Include country code without + or spaces (example: 2010xxxxxxxx for Egypt).',
    'storefront_whatsapp_message' => 'Pre-filled message',
    'storefront_whatsapp_message_help' => 'Optional message that opens with the chat when the customer taps the button.',
    'storefront_whatsapp_message_placeholder' => 'Hello, I need help with my order…',
    'storefront_whatsapp_chat' => 'Chat on WhatsApp',
    'hero_badge' => 'Hero badge',
    'hero_title' => 'Hero title',
    'hero_title_help' => 'HTML is allowed. Use <span> for highlighted words and <br> for line breaks.',
    'hero_content' => 'Hero content',
    'hero_link' => 'Hero link',
    'hero_link_title' => 'Button title',
    'hero_link_url' => 'Button URL',
    'hero_image' => 'Hero image',
    'hero_image_help' => 'Recommended size: 920×800px or similar wide image.',
