...
return [
    ...
    'sale_already_exist' => 'Produkt kann nicht gelöscht werden, da ein Verkauf zu diesem Produkt existiert',
    ...
    'design' => 'Design',
    'english_arabic_design_help' => 'Dieses Design verwendet eine Kombination aus englischer und arabischer Sprache, die für saudische Unternehmen geeignet ist.',
    'english_arabic_requires_intl' => 'Das Englisch-Arabisch-Design erfordert PHP intl NumberFormatter. Bitte aktivieren Sie die intl-Erweiterung, um es zu verwenden.',
    ...
    'import_contact_id_upsert_hint' => 'Wenn diese ID in Ihrem Unternehmen bereits existiert, wird der Kontakt aus der Zeile aktualisiert; ist sie neu, wird ein Kontakt angelegt.',
    ...
    'msg_param_name' => 'NACHRICHT Parametername',
    ...
    'price' => 'Preis',
    'auto_backup_instruction' => 'Um die automatische Sicherung und die Sicherungsbereinigung zu aktivieren, müssen Sie einen Cron-Job mit diesem Befehl einrichten',
    ...
    'view_purchase_price_tooltip' => 'Berechtigung zum Anzeigen des Einkaufspreises in den Produktdetails, beim Lagertransfer und bei der Lageranpassung',    'created' => 'Erstellt',
    ...
    'enable_service_staff_pin' => 'Servicepersonal-PIN aktivieren',
    'staff_pin' => 'Mitarbeiter-PIN',
    'tooltip_is_enable_service_staff_pin' => 'Wenn aktiviert, muss während des Verkaufs/POS, wenn dieser Benutzer als Servicepersonal ausgewählt ist, eine PIN eingegeben werden. Eine falsche PIN wird die Auswahl dieses Benutzers als Servicepersonal nicht zulassen.',
    'kitchen_order' => 'Küchenbestellung',
    ...
    'enter_details_below_to_check_repair_status' => 'Geben Sie unten die Details ein, um den Reparaturstatus zu überprüfen',
    ...
    'update_product_price' => 'Preis aktualisieren',
    'signed_in_as' => 'Angemeldet als',
    'field_type' => 'Feldtyp',
    'text' => 'Text',
    'datepicker' => 'Datumsauswahl',
    'dropdown' => 'Dropdown',
    'enable_purchase_requisition' => 'Bestellanforderung aktivieren',
    'purchase_requisition_help_text' => 'Eine Bestellanforderung ist ein Dokument, das ein Mitarbeiter erstellt, um den Kauf von Waren oder Dienstleistungen anzufordern.',
    'is_commission_agent_required' => 'Ist ein Provisionsagent erforderlich?',
    'is_pay_term_required' => 'Ist eine Zahlungsfrist erforderlich?',
    'allow_overselling_help' => 'Markieren Sie dieses Feld, um einem Produkt den Verkauf über die verfügbare Menge hinaus zu ermöglichen. Die zu viel verkaufte Menge wird automatisch aus zukünftigen Beständen angepasst.',
    'enable_cash_denomination_on' => 'Bargeldstückelung aktivieren bei',
    'enable_cash_denomination_for_payment_methods' => 'Bargeldstückelung für Zahlungsmethoden aktivieren',
    'strict_check' => 'Strenge Prüfung',
    'strict_check_help' => 'Wenn aktiviert, muss der Zahlungsbetrag der Summe der Bargeldstückelungen entsprechen',
    'pos_screen' => 'POS-Bildschirm',
    'all_screen' => 'Alle Bildschirme',
    'import_export_product_price' => 'Produktpreise importieren/exportieren',
    'instructions' => 'Anweisungen',
    'price_import_instruction_1' => 'Exportieren Sie Produktpreise, indem Sie oben auf die Schaltfläche klicken',
    'price_import_instruction_2' => 'Ändern Sie den Produktpreis einschließlich Steuern und Verkaufsgruppen.',
    'price_import_instruction_3' => 'Ändern Sie keinen Produktnamen, keine SKU und keine Kopfzeilen',
    'price_import_instruction_4' => 'Importieren Sie die Datei nach Änderungen',
    'export_product_prices' => 'Produktpreise exportieren',
    'preparation_time_in_minutes' => 'Servicepersonal-Timer/Vorbereitungszeit (in Minuten)',
    'default' => 'Standard',
    'simple' => 'Einfach',
    'star_branded' => 'Star-Marke',
    'espon_tep' => 'Espon Tep',
    'network' => 'Netzwerk',
    'windows' => 'Windows',
    'linux' => 'Linux',
    'is_product_image_required' => 'Ist ein Produktbild erforderlich?',
    'currency_precision' => 'Währungspräzision',
    'currency_precision_help' => 'Anzahl der Nachkommastellen für den Währungswert. Beispiel: 0,00 für Wert 2, 0,000 für Wert 3, 0,0000 für Wert 4',
    'quantity_precision' => 'Mengenpräzision',
    'quantity_precision_help' => 'Anzahl der Nachkommastellen für den Mengenwert. Beispiel: 0,00 für Wert 2, 0,000 für Wert 3, 0,0000 für Wert 4',
    'add_as_sub_cat' => 'Als Unterkategorie hinzufügen',
    'payable' => 'Zahlbar',
    'bulk_edit' => 'Massenbearbeitung',
    'add_to_location' => 'Zur Position hinzufügen',
    'remove_from_location' => 'Von Position entfernen',
    'deactivate_selected' => 'Ausgewählte Deaktivieren',
    'deactive_product_tooltip' => 'Deaktivierte Produkte sind nicht zum Kauf oder Verkauf verfügbar',
    'profit_by_service_staff' => 'Gewinn durch Servicepersonal',
    'paid_amount' => 'Bezahlter Betrag',
    'zatca_phase' => 'Zatca-Phase',
    'select_phase' => 'Phase auswählen',
    'zatca_phase1' => 'Phase 1 - Erstellung',
    'zatca_phase2' => 'Phase 2 - Integration',
    'phase2_message' => 'Für Phase-2 stellen Sie sicher, dass Sie die Zatca-Onboarding erfolgreich abgeschlossen haben.',
    'customer_display_screen' => 'Kundenanzeigebildschirm',
    'display_screen_heading' => 'Überschrift des Anzeigebildschirms',
    'image_help' => 'Vorheriges Bild (falls vorhanden) wird ersetzt',
    'carousel_image' => 'Karussellbild :number',
    'display_screen' => 'Anzeigebildschirm',
    'enable_customer_display_screen' => 'Kundenanzeigebildschirm aktivieren',
    'customer_display_instraction' => "Damit der Kundenanzeigebildschirm funktioniert, stellen Sie sicher, dass er im gleichen Browser wie der POS-Bildschirm in einem neuen Tab geöffnet ist. Und dass dieser Tab auf einen anderen kundenorientierten Anzeigemonitor gespiegelt wird.",
    'data_parameter_type' => 'Datenparametertyp',
    'string_default' => 'String (default)',
    'array' => 'Array',
    'format_4' => 'Format 4',
    'aging_report' => 'Alterungsbericht',
    'partner_ledger' => 'Partner-Hauptbuch',
    'partner_ledger_summary' => 'Partner-Hauptbuch Zusammenfassung',
    'tax_number_already_exists' => 'Diese Steuernummer ist bereits vorhanden',
    'tax_number_already_registered' => 'Steuernummer :tax_number bereits registriert für :contacts',
    'invoice_synced_to_zatca_cannot_be_deleted' => 'Diese Rechnung wurde erfolgreich mit ZATCA synchronisiert und kann nicht gelöscht werden.',
    'invoice_synced_to_zatca_cannot_be_edited' => 'Diese Rechnung wurde erfolgreich mit ZATCA synchronisiert und kann nicht bearbeitet werden.',
    'previous_balance_due' => 'Vorheriger fälliger Saldo',
    'previous_balance_due_help' => 'Zeigt den Kundenstand vor diesem Verkauf an (schließt den fälligen Betrag des aktuellen Verkaufs aus).',
    'show_previous_balance_due' => 'Vorherigen fälligen Saldo anzeigen',
    'view_own_purchase' => 'Eigene Einkäufe anzeigen',
    'view_all_purchase' => 'Alle Einkäufe anzeigen',
];
